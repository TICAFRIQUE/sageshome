...
@section('title', 'Inscription - Sages Home')
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="auth-card mx-auto">
                        ...
                        <img src="{{ asset('images/logo.png') }}" alt="Sages Home" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                        <h4 class="brand-text" style="display: none;">SAGES HOME</h4>
                    </div> --}}

                        <!-- Header -->
                        <div class="auth-header">
                            <h3>Inscription</h3>
                            <p class="subtitle mb-0">Créez votre compte Sages Home</p>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="password-field">
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            id="password" name="password" placeholder="Choisissez un mot de passe sécurisé"
                                            required>
                    ...
                    if (confirmPassword.length > 0) {
                        if (password === confirmPassword) {
                            passwordMatch.innerHTML =
                                '<i class="fas fa-check-circle text-success me-1"></i><span class="text-success">Les mots de passe correspondent</span>';
                        } else {
                            passwordMatch.innerHTML =
                                '<i class="fas fa-times-circle text-danger me-1"></i><span class="text-danger">Les mots de passe ne correspondent pas</span>';
                        }
                    } else {
                        passwordMatch.innerHTML = '';
                    }
