...
@section('title', 'Modifier le Type de Résidence')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0">Modifier {{ $residenceType->name }}</h4>
...
<div class="row">
    <div class="col-lg-8">
        <form action="{{ route('admin.residence-types.update', $residenceType) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $residenceType->name) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="3">{{ old('description', $residenceType->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('min_capacity') is-invalid @enderror" 
                                       id="min_capacity" name="min_capacity" value="{{ old('min_capacity', $residenceType->min_capacity) }}" min="1" required>
                                @error('min_capacity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_capacity') is-invalid @enderror" 
                                       id="max_capacity" name="max_capacity" value="{{ old('max_capacity', $residenceType->max_capacity) }}" min="1" required>
                                @error('max_capacity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $residenceType->sort_order) }}" min="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                   id="is_active" {{ old('is_active', $residenceType->is_active) ? 'checked' : '' }}>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span>Résidences utilisant ce type:</span>
                ...
                @if($residenceType->residences()->count() > 0)
                    <div class="alert alert-info">
                        ...
                        Ce type est utilisé par {{ $residenceType->residences()->count() }} résidence(s). 
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted small mb-3">
                    Le nom qui sera visible par les utilisateurs. Le slug sera mis à jour automatiquement si vous modifiez le nom.
                </p>
