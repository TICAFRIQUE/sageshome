                    ...
                    <div class="card residence-card h-100 border-0 shadow-sm">
                        <div class="position-relative">
                            @if($residence->primaryImage)
                                <img src="{{ $residence->primaryImage->full_url }}" 
                                     class="card-img-top residence-image" 
                                     alt="{{ $residence->name }}"
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="text-muted">{{ $residence->bedrooms ?? 'N/A' }} chambres</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="text-gold fw-bold fs-4">{{ number_format($residence->price_per_night, 0, ',', ' ') }} FCFA</span>
                                ...
                                <div class="card-header text-white text-center py-4"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-8 text-center text-md-start">
                                            ...
                                            <p class="text-white-75 mb-0">{{ $residenceType->description ?? 'Découvrez nos résidences de qualité' }}</p>
                                        </div>
                                        <div class="col-md-2 text-center">
                                            <span class="badge bg-white text-dark px-3 py-2 fs-6">
                                                {{ $residenceType->residences->count() }} résidence{{ $residenceType->residences->count() > 1 ? 's' : '' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card residence-card h-100 border-0 shadow-sm">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="row g-2 mb-3 text-center">
                                            <div class="col-4">
                                                <div class="d-flex flex-column align-items-center">
                                                    <i class="fas fa-users mb-1" style="color: var(--sage-gold-end);"></i>
                                                    <small class="text-muted">{{ $residence->capacity }}p</small>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="d-flex flex-column align-items-center">
                                                    <i class="fas fa-bed mb-1" style="color: var(--sage-gold-end);"></i>
                                                    <small class="text-muted">{{ $residence->bedrooms ?? 'N/A' }}</small>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="d-flex flex-column align-items-center">
                                                    <i class="fas fa-star mb-1" style="color: var(--sage-gold-end);"></i>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <span class="text-gold fw-bold fs-5">{{ number_format($residence->price_per_night, 0, ',', ' ') }} FCFA</span>
                                                <small class="text-muted d-block">par nuit</small>
                                            </div>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('residences.index', ['type' => $residenceType->id]) }}" 
                           class="btn btn-primary btn-lg px-4">
                            <i class="fas fa-eye me-2"></i>Voir toutes les {{ $residenceType->name }} ({{ $residenceType->residences->count() }})
                        </a>
                    </div>
                    @endif
                </div>
