    ...
    <div class="content">
        ...
        <div class="booking-details">
            ...
            <div class="detail-row">
                ...
                <span class="value">{{ $booking->residence->ville ?? '' }}
                    {{ $booking->residence->commune ?? '' }}</span>
            </div>
        ...
        <ul>
            <li>Email : {{ env('MAIL_FROM_ADDRESS', 'infos@sageshome.ci') }}</li>
            <li>Téléphone :   {{  $parametre?->contact2 }}</li>
        </ul>
    </div>
